...
import com.ccuwu.a789betkhngngng.databinding.ActivityGameBinding
import java.util.*
import kotlin.math.abs

class BetGameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            gWebView?.loadUrl("file:///android_asset/crossyRoad/dist/index.html?lang=" + Locale.getDefault().language)
        }
