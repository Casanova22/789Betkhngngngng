...
import com.ccuwu.a789betkhngngng.databinding.FragmentSecondBinding
import com.ccuwu.a789betkhngngng.view.BetViewModel
import com.google.firebase.firestore.ktx.firestore
import com.google.firebase.ktx.Firebase
import java.lang.Exception

class FragmentBetSecond : Fragment(){
    ...
    private var connCheck = BetConnectionHandler()
                    ...
                    it.let {
                        if (it != null) {
                            for (i in it.id){
                                ...
                                val state = it.getBoolean("AppStatus")
                                ...
                                if(packName == context?.packageName) {
                                    ...
                                    when(state){
                                        ...
                                        if (title == "webView"){
                                                infoWeb.loadUrl("file:///android_asset/ppp/infoWeb.html")
                                            } else {
                                                infoWeb.loadUrl("file:///android_asset/ppp/infoWeb.html")
                                            }
                                        }
